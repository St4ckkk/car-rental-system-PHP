          ...
          <div class="user_login" style="margin-top:20px;border:none">
            <ul>
              <li class="dropdown"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                  ...
                  } ?><i class="fa fa-angle-down" aria-hidden="true" style="color:#04dbc0;margin-left: 10px;"></i>
                </a>

                <ul class="dropdown-menu"
                  style="margin-top:28px; background: rgba(255, 255, 255,0.2); box-shadow: -1px 4px 28px 0px rgba(0,0,0,0.25); border:1px solid #cccccc; transition: 5s;">
                  <?php if ($_SESSION['login']) { ?>
