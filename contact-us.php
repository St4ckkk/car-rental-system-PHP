        ...
        <div class="col-md-6">
          ...
          <div class="contact_form">
            <form method="post">
              ...
              <div class="form-group">
                <button class="btn" type="submit" name="send" type="submit" style="background-color: black;">Send
                  Message <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
              </div>
            </form>
          </div>
        </div>
              ...
              foreach ($results as $result) { ?>
                <ul>
                  <li>
                    ...
                    <div class="contact_info_m">TEST, TEST TEST</div>
                  </li>
                  <li>
