...
if (isset($_POST['submit'])) {
  ...
  // Retrieve user ID if needed for logging
  $userId = getUserIdFromEmail($useremail); // You would need to implement this function to get the user ID based on email

  if ($lastInsertId) {
    echo "<script>alert('Booking successful.');</script>";
    logActivity($userId, 'Booking Success', "Please check your email for your booking confirmation!");
  } else {
    echo "<script>alert('Something went wrong. Please try again');</script>";
    logActivity($userId, 'Booking Failed', "Failed to book vehicle ID $vhid");
  }
}
...
{
  global $dbh;
  $stmt = $dbh->prepare("SELECT id FROM tblusers WHERE EmailId = :email");
          ...
          <div class="listing_detail_head row">
            ...
            <div class="col-md-3">
              <div class="price_info">
                <p style="color: #333"><span style="font-size:25px"><span>&#8369;</span>
                  </span>
